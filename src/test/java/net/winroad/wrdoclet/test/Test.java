...
public class Test {
	public static void main(String[] args) {
		...
		String[] docArgs = new String[] {
				...
				"-showannotationlist",
				"net.winroad.Models.LoginAuthority,org.springframework.web.bind.annotation.RequestMapping",
				"-authkeyword",
				"REQUEST_COOKIE_AUTH,REQUEST_BODY_AUTH",
				"-noauthkeyword",
				"NO_AUTH,OPTIONAL_AUTH",
				"-cmzfieldexclude", 
				"net.winroad.config.JsonResult.exclude",
				"-cmzfieldinclude",
				"net.winroad.config.JsonResult.include",
				"-sourcepath",
